...
const Subtitle = (text_subtitle) => {
  ...
  const text = $("<h3 class='text-center'>" + text_subtitle + "</h3>");
...
const Confirm_btn = (text, callback) => {
  const btn_container = $("<div class='btn-container text-center' id='bt-container' ></div>");
...
const Checkbox = () => {
  ...
  const checkbox = $("<input type='checkbox' class='data' id='terms' >");
